...
was;
defined.
    See[GalaxyStory.md](https, Installation, Pre - requisites
    - [Node](https, //nodejs.org) >= 4
    -[Mocha](https, (_a = [""], _a.raw = [""], (_b = ["sh\n$ git clone https://github.com/dennisjade/merchant-galaxy-calculator.git\n$ cd merchant-galaxy-calculator\n$ npm install\n$ node start\n"], _b.raw = ["sh\n$ git clone https://github.com/dennisjade/merchant-galaxy-calculator.git\n$ cd merchant-galaxy-calculator\n$ npm install\n$ node start\n"], (_c = [""], _c.raw = [""], Steps(_c))(_b))(_a)), (_d = [""], _d.raw = [""], (_e = ["sh\n$ npm test\n"], _e.raw = ["sh\n$ npm test\n"], (_f = [""], _f.raw = [""], Test(_f))(_e))(_d)), Module, Diagram, ![Routing](docs / images / router.png, "Routes"), ![Compute, API](docs / images / compute - api.png, "Compute API"), git, ![Input, API](docs / images / input - api.png, "Input API"), ![Cache, data, struc](docs / images / cache - data - sample.png, "Cache data struc"), APIs
